...
export type ViewType = 'HOME' | 'DASHBOARD' | 'ESTATISTICAS' | 'REGISTRAR' | 'HISTORICO' | 'SIMULADOS' | 'CONFIGURAR' | 'ONBOARDING' | 'FLASHCARDS' | 'REGISTRAR_SIMULADO' | 'HUB' | 'RANKING' | 'LIBRARY';