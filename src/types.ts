...
export type ViewType = 'HOME' | 'DASHBOARD' | 'EDITAL' | 'REGISTRAR' | 'HISTORICO' | 'SIMULADOS' | 'CONFIGURAR' | 'ONBOARDING' | 'EDITAL_PROGRESS' | 'FLASHCARDS' | 'ANALISE_ERROS' | 'REGISTRAR_SIMULADO' | 'HUB' | 'RANKING' | 'LIBRARY';