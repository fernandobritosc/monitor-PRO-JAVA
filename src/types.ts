...
export type ViewType = 'HOME' | 'DASHBOARD' | 'EDITAL' | 'REGISTRAR' | 'HISTORICO' | 'SIMULADOS' | 'CONFIGURAR' | 'ONBOARDING' | 'EDITAL_PROGRESS' | 'FLASHCARDS' | 'REGISTRAR_SIMULADO' | 'HUB' | 'RANKING' | 'LIBRARY';