...
const App: React.FC = () => {
  ...
  const renderView = () => {
    switch (activeView) {
      ...
      case 'REVISOES': return <Revisoes records={studyRecords} missaoAtiva={missaoAtiva} editais={editais} onRecordUpdate={handleRecordUpdate} onUpdated={() => fetchData(session.user.id)} />;
