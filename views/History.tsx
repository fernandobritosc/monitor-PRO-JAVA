                  ...
                  {isOpen && (
                     <div className="border-t border-white/5 bg-black/20 animate-in slide-in-from-top-2">
                        {recordsInGroup.map(r => (
                           <div key={r.id} className={`p-4 border-b border-white/5 last:border-0 hover:bg-white/[0.02] transition-colors flex flex-col md:flex-row gap-4 justify-between items-start md:items-center group ${deletingId === r.id ? 'opacity-30' : ''}`}>
              ...
              <div className="space-y-8">
                 ...
                 <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-medium"
