...
const StudyForm: React.FC<StudyFormProps> = ({ editais, missaoAtiva, onSaved, isSimulado = false, onCancel }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto animate-in fade-in zoom-in-95 duration-500 pb-20">
      ...
      <div className="glass rounded-2xl p-6 shadow-2xl border-white/5 relative overflow-hidden"> {/* Reduzido de 3xl p-8 */}
        ...
        <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                 <input
                  type="date"
                  required
                  className="flex-1 bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-medium" {/* Ajustado de /900 e /10 */}
                  value={dataEstudo}
                ...
                <input
                  ...
                  maxLength={5}
                  required
                  className="w-32 bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-medium text-center" {/* Ajustado de /900 e /10 */}
                  value={tempoHHMM}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-medium placeholder-slate-600" {/* Ajustado de /900 e /10 */}
                value={assunto}
          ...
          {isSimulado ? (
            ...
            <div className="space-y-4">
               ...
               <div className="glass bg-slate-900/30 rounded-xl p-1 border border-white/5 space-y-1 max-h-[400px] overflow-y-auto custom-scrollbar"> {/* Ajustado de /40 2xl p-2 */}
                  {materiasDisponiveis.map(mat => {
                      ...
                      return (
                          <div key={mat} className="grid grid-cols-12 gap-4 items-center p-2 hover:bg-white/5 rounded-lg transition-colors"> {/* Ajustado de p-3 2xl */}
                              <div className="col-span-6 font-bold text-sm text-slate-300 truncate" title={mat}>{mat}</div>
                              <div className="col-span-3">
                                  <input 
                                    type="number" 
                                    placeholder="0" 
                                    className={`w-full bg-slate-950/30 border ${isInvalid ? 'border-red-500 text-red-400' : 'border-white/10 text-green-400'} rounded-lg px-2 py-1.5 text-center text-sm font-bold focus:outline-none focus:ring-1 focus:ring-purple-500/50 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`} {/* Ajustado de /950 */}
                                    value={score.acertos}
                              ...
                              <div className="col-span-3">
                                  <input 
                                    type="number" 
                                    placeholder="0" 
                                    className="w-full bg-slate-950/30 border border-white/10 rounded-lg px-2 py-1.5 text-center text-sm font-bold text-white focus:outline-none focus:ring-1 focus:ring-purple-500/50 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" {/* Ajustado de /950 */}
                                    value={score.total}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                        <div className="space-y-1">
                            ...
                            <input
                                type="number"
                                min="0"
                                className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all text-white font-bold text-lg [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" {/* Ajustado de /900 e /10 */}
                                value={acertos}
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                type="number"
                                min="1"
                                className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-bold text-lg [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" {/* Ajustado de /900 e /10 */}
                                value={total}
          ...
          <div className="flex gap-4 pt-4 border-t border-white/5">
            {isSimulado && onCancel && (
                <button 
                   type="button" 
                   onClick={onCancel}
                   className="flex-1 bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white font-bold py-4 rounded-xl transition-all border border-white/5" {/* Reduzido de 2xl */}
                >
                   CANCELAR
                </button>
            )}
