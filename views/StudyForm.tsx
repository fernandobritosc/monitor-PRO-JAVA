...
const StudyForm: React.FC<StudyFormProps> = ({ editais, missaoAtiva, onSaved, isSimulado = false, onCancel }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto animate-in fade-in zoom-in-95 duration-500 pb-20">
      ...
      <div className="glass rounded-2xl p-6 shadow-2xl border-white/5 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                 <input
                  type="date"
                  required
                  className="flex-1 bg-slate-900/30 border border-white/5 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-medium"
                  value={dataEstudo}
                ...
                <input
                  ...
                  maxLength={5}
                  required
                  className="w-32 bg-slate-900/30 border border-white/5 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-medium text-center"
                  value={tempoHHMM}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-medium placeholder-slate-600"
                value={assunto}
            ...
            <div className="space-y-4">
             ...
             <>
                <div className="space-y-2">
                    ...
                    <select
                        required
                        className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-medium appearance-none"
                        value={materia}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        <div className="space-y-1">
                            ...
                            <input
                                type="number"
                                min="0"
                                className="w-full bg-slate-900/30 border border-white/5 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all text-white font-bold text-lg [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                value={acertos}
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                type="number"
                                min="1"
                                className="w-full bg-slate-900/30 border border-white/5 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all text-white font-bold text-lg [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                value={total}
                                onChange={(e) => setTotal(e.target.value)}
                            />
                        </div>
                        <div className="flex flex-col items-center justify-center bg-slate-800/50 rounded-lg p-2 border border-white/5 h-full">
                            <span className="text-[10px] text-slate-500 font-bold uppercase mb-1">Taxa</span>
                            <div className={`text-3xl font-black transition-colors duration-500 ${singleStats.percentage >= 80 ? 'text-green-400' : singleStats.percentage >= 60 ? 'text-yellow-400' : 'text-red-400'}`}>
          ...
          <div className="flex gap-4 pt-4 border-t border-white/5">
            {isSimulado && onCancel && (
                <button 
                   type="button" 
                   onClick={onCancel}
                   className="flex-1 bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white font-bold py-3 rounded-xl transition-all border border-white/5"
                >
                   CANCELAR
                </button>
            )}
