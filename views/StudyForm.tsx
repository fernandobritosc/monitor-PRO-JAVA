...
// import pkg from '../package.json'; // REMOVIDO para corrigir erro de sintaxe no build
  ...
  return (
    <div className="max-w-4xl mx-auto animate-in fade-in zoom-in-95 duration-500 pb-20">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <>
             ...
             <>
                ...
                <div className="glass p-6 rounded-2xl border border-white/5 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* FIX: Corrected typo 'Difícl' to 'Difícil' */}
        ...
        <div className="text-center mt-8 text-xs text-slate-600 font-mono tracking-wider">
            {currentTime} (Brasília)
        </div>
    </div>
  );
};
