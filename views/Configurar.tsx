...
import { PlusCircle, Shield, Search, Loader2, Edit, Trash2, Save, X, RefreshCw, Calendar, BookOpen, CheckCircle2, AlertTriangle, Terminal, Database, Copy, Activity, FileText, DownloadCloud, Users, ArrowRight } from 'lucide-react';
             ...
             <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                 ...
                 <div className="relative w-full md:w-64">
                    ...
                    <input 
                        ...
                        className="w-full bg-slate-900 border border-white/10 rounded-xl pl-9 pr-4 py-2 text-xs" 
                        value={importSearch} 
             ...
             {loadingTemplates ? (
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredTemplates.map(tmpl => (
                        <div key={tmpl.id} className="bg-slate-900/40 border border-white/5 rounded-2xl p-6 hover:border-blue-500/50 transition-all group hover:bg-slate-900/60 relative">
