  ...
  const handleDeleteMission = async (concurso: string) => {
    ...
    try {
      ...
      if (deleteError) {
          ...
          const deleteErrorMessage = (typeof deleteError === 'object' && deleteError !== null && 'message' in deleteError) 
                                     ? deleteError.message 
                                     : String(deleteError);
          const deleteErrorCode = (typeof deleteError === 'object' && deleteError !== null && 'code' in deleteError) 
                                  ? deleteError.code 
                                  : null;
