...
const SimuladoSubjectRow: React.FC<{ 
  ...
  return (
    <div className="bg-slate-900/40 rounded-xl p-3 border border-white/5 hover:bg-white/5 transition-colors">
        {isEditing ? (
             <div className="space-y-3">
                 ...
                 <div className="flex items-center gap-2">
                     <div className="flex-1">
                         ...
                         <input 
                           type="number" 
                           className={`w-full bg-slate-950 border ${isInvalid ? 'border-red-500 text-red-400' : 'border-white/10 text-green-400'} rounded px-2 py-1.5 text-center font-bold focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`}
                           value={localAcertos} 
                     ...
                     <div className="flex-1">
                         ...
                         <input 
                           type="number" 
                           className="w-full bg-slate-950 border border-white/10 rounded px-2 py-1.5 text-center font-bold text-white focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                           value={localTotal} 
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-500 pb-20">
       ...
       {groupedSimulados.length === 0 ? (
         <div className="glass rounded-3xl p-12 md:p-20 text-center space-y-6 border border-white/5">
         ...
         <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
               <div className="glass p-5 rounded-2xl border-b-4 border-yellow-500">
               ...
               <div className="glass p-5 rounded-2xl border-b-4 border-cyan-500">
               ...
               <div className="glass p-5 rounded-2xl border-b-4 border-green-500">
            ...
            <div className="space-y-4">
               ...
               <div className="grid grid-cols-1 gap-4">
                  {groupedSimulados.map(group => {
                    ...
                    return (
                        <div key={group.id} className={`glass rounded-2xl overflow-hidden border-l-4 ${colorClass}`}>
                            {/* Card Header (Click to Expand) */}
                            <div className="p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 hover:bg-white/[0.02] transition-all cursor-pointer" onClick={() => toggleExpand(group.id)}>
                            ...
                            {/* Expanded Details */}
                            {isExpanded && (
                                <div className="bg-slate-900/50 border-t border-white/5 p-4 animate-in slide-in-from-top-2">
