        ...
        <div className="space-y-4">
          ...
          {isAnalysisVisible && (
            <div className="glass rounded-xl p-6 animate-in fade-in slide-in-from-top-2">
                <div className="prose prose-sm prose-invert max-w-none prose-p:my-2 prose-li:my-1 whitespace-pre-wrap break-all" style={{ '--tw-prose-invert-body': '#d1d5db' } as React.CSSProperties}>
