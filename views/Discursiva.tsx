...
import { 
  FilePenLine, UploadCloud, Loader2, Sparkles, Download, Database, Copy, X, Trash2, Image as ImageIcon, MessageSquare, List, AlertTriangle
} from 'lucide-react';
  ...
  const AnalysisView = ({ analysis }: { analysis: DiscursivaType }) => (
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-in fade-in">
        ...
        <div className="space-y-4">
            ...
            <div className="glass rounded-xl p-6 prose prose-sm prose-invert max-w-none prose-h2:text-cyan-400 prose-h3:mt-4 prose-strong:text-white" style={{'--tw-prose-invert-body': '#d1d5db', '--tw-prose-invert-hr': 'rgba(255,255,255,0.1)'}}>
      ...
      <div className="flex justify-between items-start">
        <div>
          <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent flex items-center gap-3">
             <FilePenLine /> Corretor de Discursiva
          </h2>
