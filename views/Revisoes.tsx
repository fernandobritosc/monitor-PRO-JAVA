...
const ReviewCard: React.FC<ReviewCardProps> = ({ item, isOverdue, isExpanded, onToggle, onComplete }) => {
  ...
  return (
    <div className={`glass rounded-xl p-4 border-l-2 transition-all hover:bg-white/[0.02] ${isOverdue ? 'border-red-500' : 'border-green-500'}`}>
      ...
      <div className="relative">
        ...
        {hasNotes && isExpanded && (
           <div className="mt-4 p-3 bg-slate-900/30 rounded-xl border border-white/5 animate-in fade-in">
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-500 pb-20">
          ...
          <div className="glass p-5 rounded-xl border border-white/10 animate-in slide-in-from-top-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               ...
               <div className="space-y-1">
                 ...
                 <div className="relative">
                   <select 
                     className="w-full bg-slate-900/30 border border-white/5 rounded-xl pl-4 pr-10 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 appearance-none text-slate-300"
                     value={filterMateria}
               ...
               <div className="space-y-1">
                 ...
                 <div className="relative">
                   ...
                   <input 
                     ...
                     className="w-full bg-slate-900/30 border border-white/5 rounded-xl pl-9 pr-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500"
                     value={filterAssunto}
      ...
      {overdue.length === 0 && today.length === 0 ? (
        <div className="glass rounded-2xl p-16 text-center space-y-4 border-dashed border-2 border-slate-800">
            ...
            <div className="overflow-y-auto pr-2 custom-scrollbar space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                        type="date"
                        className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 text-white font-bold"
                        value={reviewDate}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="HH:MM"
                        maxLength={5}
                        className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 text-white font-bold text-center"
                        value={tempoHHMM}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-900/30 border border-white/5 rounded-xl pl-12 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 text-white font-bold text-right [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                    />
                  </div>
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-900/30 border border-white/5 rounded-xl pl-14 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500/50 text-white font-bold text-right [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                    />
                  </div>
                </div>
