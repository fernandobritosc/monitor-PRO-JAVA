...
// @google/genai-sdk-validator-fix: Use Number() to ensure arithmetic operation is on numbers.
// Fix: valB and valA are numbers and should not be called as functions.
      return valB - valA;
    });
