...
const Login: React.FC<LoginProps> = () => {
  ...
  return (
    <div className="min-h-screen bg-[#12151D] flex items-center justify-center p-4 relative overflow-hidden font-['Montserrat']">
      ...
      {/* DEBUG FOOTER */}
      <div className="absolute bottom-2 right-2 text-[9px] text-slate-700 font-mono text-right opacity-50 hover:opacity-100 transition-opacity pointer-events-none flex flex-col gap-1 hidden md:flex">
