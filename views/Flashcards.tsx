...
// SCRIPT SQL CORRIGIDO: Remove duplicatas antes de criar o índice único
...
-- LIMPEZA DE DUPLICATAS (Mantém o registro mais recente)
...
-- Recria índice único de forma segura
