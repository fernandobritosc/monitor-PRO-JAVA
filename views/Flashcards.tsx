...
const Flashcards: React.FC<FlashcardsProps> = ({ missaoAtiva, editais }) => {
  ...
  const [filterAssunto, setFilterAssunto] = useState<string>('Todos'); // NOVO
  ...
  // NOVO: Opções dinâmicas de Assunto
  ...
  // ATUALIZADO: Filtro de Assunto incluído
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {activeTab === 'manage' && (
          <div className="glass rounded-2xl p-6 shadow-xl space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
                <button onClick={() => setShowAdvancedFilters(!showAdvancedFilters)} className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl text-xs font-bold flex items-center gap-2"><Filter size={14} /> Filtros</button>
