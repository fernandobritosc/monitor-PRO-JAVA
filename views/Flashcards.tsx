...
import { streamAIContent, AIProvider, speakTextWithGemini, generatePodcastAudio, handlePlayRevisionAudio } from '../services/aiService';
...
const Flashcards: React.FC<FlashcardsProps> = ({ missaoAtiva, editais }) => {
  ...
  const handlePlayNeural = async () => {
      ...
      const cancel = await handlePlayRevisionAudio(
          aiStreamText,
          currentCard.id, // Usa o ID do card como chave de cache
          key,
          () => setIsPlayingNeural(true),
          () => setIsPlayingNeural(false),
