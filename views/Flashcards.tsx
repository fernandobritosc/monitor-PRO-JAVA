                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        {!editingId && (newCard.materia || newCard.assunto || newCard.front || newCard.back) && (
                             <button 
                                onClick={() => setNewCard({ front: '', back: '', materia: '', assunto: '' })} 
                                className="text-xs text-white font-bold flex items-center gap-1 bg-slate-700 hover:bg-red-500/20 hover:text-red-400 px-3 py-1.5 rounded-lg border border-white/10 transition-colors shadow-sm"
