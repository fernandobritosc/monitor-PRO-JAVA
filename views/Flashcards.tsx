...
import { 
  ...
  Globe, Database, Copy, ChevronDown, Eye, Sparkles, AlertTriangle, Volume2, Info, Lock, ChevronLeft, ChevronRight, Trophy, Target, Tag, Send, MessageSquarePlus, ChevronUp, Headphones, Square, Mic2, FileAudio, RefreshCw, User, Music
} from 'lucide-react';
            ...
            {studyQueue.length === 0 ? (
              ...
              <div className="perspective-1000">
                ...
                <div className={`absolute inset-0 backface-hidden rotate-y-180 bg-gradient-to-br from-purple-900/80 to-purple-800/80 border-2 border-purple-500/30 rounded-2xl p-5 md:p-8 flex flex-col ${isFlipped ? 'opacity-100' : 'opacity-0'}`}>
                  ...
                  <div className="mt-4 pt-4 border-t border-purple-500/20 shrink-0">
