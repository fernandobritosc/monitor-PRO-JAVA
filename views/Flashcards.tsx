          ...
          <div className="glass rounded-2xl p-6 shadow-xl space-y-6">
            ...
            <div className="bg-slate-900/30 border border-white/5 rounded-2xl p-6">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="flex gap-2">
                        {/* Botão Limpar (Apenas quando criando e se houver dados) */}
                        {!editingId && (newCard.materia || newCard.assunto || newCard.front || newCard.back) && (
                             <button onClick={() => setNewCard({ front: '', back: '', materia: '', assunto: '' })} className="text-xs text-slate-400 hover:text-white font-bold flex items-center gap-1 bg-slate-800 px-3 py-1.5 rounded-lg border border-white/5 transition-colors">
