...
const Flashcards: React.FC<FlashcardsProps> = ({ missaoAtiva, editais }) => {
  ...
  // SUGESTÃO DE TÓPICOS PARA O CAMPO ASSUNTO
...
import { 
  Zap, Plus, Trash2, Layers, Brain, CheckCircle2, XCircle, RotateCcw, 
  Loader2, Filter, BookOpen, Edit2, Save, X, DownloadCloud, Users, 
  Globe, Database, Copy, ChevronDown, Shuffle, Eye, Sparkles, AlertTriangle, Settings, Volume2, Info, List, RefreshCw
} from 'lucide-react';
          ...
          <div className="glass rounded-2xl p-6 shadow-xl space-y-6">
            ...
            <div className="bg-slate-900/30 border border-white/5 rounded-2xl p-6">
                ...
                <button 
                    ...
                    className={`px-6 py-3 rounded-xl font-bold flex items-center gap-2 text-white transition-all ${editingId ? 'bg-yellow-600 hover:bg-yellow-500' : 'bg-cyan-600 hover:bg-cyan-500'}`}
                >
